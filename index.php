        ...
        <div class="container">
            ...
            <div class="services-grid">
                <?php foreach ($services as $service): ?>
                    <div class="tilt-card fade-in-scroll">
                        <div class="card" onmouseenter="this.querySelectorAll('.toggle').forEach(child => {child.classList.toggle('active');});" onmouseleave="this.querySelectorAll('.toggle').forEach(child => {child.classList.toggle('active');});">
                            ...
                            <div class="content">
                                <div class="icon">
                                    <img src="https://grey-trout-472951.hostingersite.com/dev/assets/images/logo.svg" alt="Logo" class="logo" style="width: 90px !important;">
                                </div>
                                <div class="bottom toggle">
                                    <h4><?php echo $lang === 'ar' ? $service['title_ar'] : $service['title_en']; ?></h4>
    ...
    <!-- <div class="centeralized">
        <div class="card" onmouseenter="this.querySelectorAll('.toggle').forEach(child => {child.classList.toggle('active');});" onmouseleave="this.querySelectorAll('.toggle').forEach(child => {child.classList.toggle('active');});">
            ...
            <div class="content">
                ...
                <div class="bottom toggle">
                    <h4><?php echo $trans['custom']['enlight_title']; ?></h4>
                    <p><?php echo $trans['custom']['enlight_subtitle']; ?></p>
                </div>
            </div>
        </div>
        <div class="card" onmouseenter="this.querySelectorAll('.toggle').forEach(child => {child.classList.toggle('active');});" onmouseleave="this.querySelectorAll('.toggle').forEach(child => {child.classList.toggle('active');});">
